...
public class MainActivity extends Activity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		ampmid = (TextView) findViewById(R.id.ampmid);
			...
			public void run() {
				runOnUiThread(new Runnable() {
					...
					public void run() {
						...
						dateid.setText(new SimpleDateFormat("(cccc) dd-MM-yyyy").format(calender.getTime()));
						ampmid.setText(new SimpleDateFormat("a").format(calender.getTime()));
					}
				});
			}
		};
	...
	private void _theme () {
		if (themedata.getString("themedata", "").equals("Dark")) {
			...
			ampmid.setTextColor(0xFFFFFFFF);
			...
			ampmid.setTextColor(0xFF000000);
